...
def asr_e():
    try:
        ...
        with sr.Microphone() as source:
            ...
            audio=r.listen(source,None,time)
            try:
                ...
                with open('Converted_eng_to_original_'+user+'.txt', 'a') as f:
                        f.write(text+'\n')
                print('You said :{}'.format(text))
                with open('Converted_eng_to_hindi'+user+'.txt', 'ab') as f:
                        f.write(f'{hindi}\n'.encode())
                ...
                with open('Converted_eng_to_gujarati'+user+'.txt', 'ab') as f:
                        f.write(f'{gujarati}\n'.encode())
                ...
                ent_2_original_txt.grid(row=2,column=1, sticky="e")
...
def asr_h():
    try:
        ...
        with sr.Microphone() as source:
            ...
            audio=r.listen(source,None,time)
            try:
                text=r.recognize_google(audio,language='hi-EN')
                ...
                gujarati = translator.translate(text)
                with open('Converted_hindi_to_original'+user+'.txt', 'ab') as f:
                        f.write(f'{text}\n'.encode())
                print('You said :{}'.format(text))
                with open('Converted_hindi_to_eng'+user+'.txt', 'a') as f:
                        f.write(eng+'\n')
                print('English translation :{}'.format(eng))
                with open('Converted_hindi_to_gujarati'+user+'.txt', 'ab') as f:
                       f.write(f'{gujarati}\n'.encode())
                print('Gujarati translation :{}'.format(gujarati))
                ...
                ent_3_eng_txt.grid(row=3,column=1, sticky="e")
                lbl_3_eng_txt = tk.Label(master=frm_entry, text="English Translation:",fg='blue',font=("Times New Roman", 25))
                #lbl_2_original_txt = tk.Label(master=frm_entry)
                lbl_3_eng_txt.grid(row=3, column=0, sticky="e")
                lbl_3_eng_txt.grid(row=3, column=0, padx=10)
    ...
    try:
        ...
        with sr.Microphone() as source:
            ...
            try:
                ...
                eng = translator.translate(text)
                with open('Converted_guj_to_original'+user+'.txt', 'ab') as f:
                        f.write(f'{text}\n'.encode())
                print('You said :{}'.format(text))
                with open('Converted_guj_to_eng'+user+'.txt', 'a') as f:
                        f.write(eng+'\n')
                print('English translation :{}'.format(eng))
                with open('Converted_guj_to_hindi'+user+'.txt', 'ab') as f:
                        f.write(f'{hindi}\n'.encode())
                print('Hindi translation :{}'.format(hindi))
                ...
                ent_4_hindi_txt.grid(row=4,column=1, sticky="e")
                lbl_4_hindi_txt = tk.Label(master=frm_entry, text="Hindi Translation:",fg='blue',font=("Times New Roman", 25))
                #lbl_2_original_txt = tk.Label(master=frm_entry)
                lbl_4_hindi_txt.grid(row=4, column=0, sticky="e")
                lbl_4_hindi_txt.grid(row=4, column=0, padx=10)
...
action_cb.grid(row=1,column=1, sticky="w")
action_cb_lbl = tk.Label(text="Select the language you will speak: ",master=frm_entry, fg='blue',font=("Times New Roman",25))
action_cb_lbl.grid(row=1, column=0, sticky="e")
action_cb_lbl.grid(row=1, column=0)
